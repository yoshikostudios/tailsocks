...
class TestBindAddress(unittest.TestCase):
    ...
    def test_start_server_command_uses_correct_bind_address(self, mock_print, mock_popen):
    ...
    def test_start_server_output_message(self, mock_print, mock_popen):
        ...
        for call in mock_print.call_args_list:
            if call[0] and "SOCKS5 proxy will be available at 192.168.1.1:8080" in call[0][0]:
                found_message = True
                break
